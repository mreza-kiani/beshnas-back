...
return [
    ...
    */
    ...
    'exists'               => ':attribute مورد نظر یافت نشد.',
    ...
    'min'                  => [
        'numeric' => 'فیلد :attribute باید حدقل :min عدد داشته باشد.',
    ...
    */
    ...
    'attributes' => [
        ...
        "password_confirmation" => "تکرار کلمه ی عبور" ,
        "email" => "ایمیل",
        "old_password" => 'کلمه ی عبور قدیمی' ,
        "new_password" => "کلمه ی عبور جدید",
        "new_password_confirmation" => 'تایید کلمه ی عبور',
        "id" => 'شناسه',
        "title" => 'عنوان',
        "description" => 'توضیحات',
        "priority" => 'اولیت',
